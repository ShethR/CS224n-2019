...
class PartialParse(object):
    ...
    def parse_step(self, transition):
        ...
        if transition == "LA":
            # marks the second item on the stack as a dependent of
        ...
        if transition == "RA":
            # marks the first item on the stack as a dependent of the second
...
def minibatch_parse(sentences, model, batch_size):
    ...
    while unfinished_parses:
        try:
            ...
            print("error occured")
        completed = []
        for i, transition in enumerate(pred_transitions):
